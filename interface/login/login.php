...
if ('left' == $GLOBALS['login_page_layout']) {
...
} elseif ('right' == $GLOBALS['login_page_layout']) {
...
<head>
    ...
    <?php } ?>
    <script>
        var registrationTranslations = <?php echo json_encode([
        ...
        var registrationConstants = <?php echo json_encode([
      ...
      <div class="<?php echo $loginrow; ?>">
          <div class="<?php echo $formarea; ?>">
              ...
              // collect languages if showing language menu
                ...
                ?>
              <?php if (isset($_SESSION['relogin']) && (1 == $_SESSION['relogin'])) { // Begin relogin dialog?>
              ...
              if (isset($_SESSION['loginfailure']) && (1 == $_SESSION['loginfailure'])) { // Begin login failure block?>
            ...
            <?php echo $div_app; ?>
            <?php if ($GLOBALS['language_menu_login'] && (1 != count($result3))) { // Begin language menu block?>
                        ...
                        <select class="form-control" name="languageChoice" size="1">
                            ...
                            foreach ($result3 as $iter) {
                                if ($GLOBALS['language_menu_showall']) {
                                    if (!$GLOBALS['allow_debug_language'] && 'dummy' == $iter['lang_description']) {
          ...
          <div class="<?php echo $logoarea; ?>">
            ...
            <div class="text-center">
              <span class="d-inline-block w-40">
                  <img src="<?php echo $GLOBALS['images_static_relative']; ?>/medixbot-logo.png" alt="medixbot-logo">
